...
class SimpleDrawer:
    def __init__(self, dataset):
        ...
        # self.drawHistogram(self.dataset.getDataByName("utils_tbo"), title="Histogram TBO", pic_name="hist_tbo")
        # self.drawHistogram(self.dataset.getDataByName("utils_tts"), title="Histogram TTS", pic_name="hist_tts")
        # self.drawHistogram(self.dataset.getDataByName("customers_tbo"), title="Histogram TBO-Cliente", pic_name="hist_client_tbo")
        # self.drawHistogram(self.dataset.getDataByName("orders_total_price"), title="Histogram Ticket", pic_name="hist_price")
